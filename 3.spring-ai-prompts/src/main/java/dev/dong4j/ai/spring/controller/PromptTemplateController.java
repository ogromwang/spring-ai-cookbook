 ...
 * PromptTemplate 控制器
 *
 * <p>该控制器演示 Spring AI 中 PromptTemplate 的使用方法，包括： 1. 基础模板占位符 {variable} 使用 2. 自定义分隔符 <variable> 模板
 * 3. 从资源文件加载模板
 *
 * @author ogromwang
 * @version 1.0.0
...
public class PromptTemplateController {
     ...
     * 演示基础模板占位符
     *
     * <p>该方法展示了如何使用基础的 {variable} 占位符来创建可重用的提示词模板。 这是最常见的模板使用方式，适用于大多数场景。
     *
     * @param adjective 形容词
     * @param topic 主题
     * @return AI 模型的回复内容
     ...
     * 演示自定义分隔符的模板
     *
     * <p>该方法展示了如何使用自定义的分隔符来避免与 JSON 等格式冲突。 当模板内容包含复杂格式时，这种技术特别有用。
     *
        ...
        try {
            ...
            String templateContent =
                    StreamUtils.copyToString(
                            systemResource.getInputStream(), StandardCharsets.UTF_8);
